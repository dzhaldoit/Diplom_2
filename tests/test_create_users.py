...
class TestCreateUser:
    ...
    def test_create_user(self, api_request_and_validate):
        data = RandomUsers().generate_random_data()
        response = api_request_and_validate(Endpoints.REGISTER,
                                            method='post',
                                            data=data)
    ...
    def test_create_user_already_registered(self, api_request_and_validate):
    ...
    def test_create_user_missing_required_field(self, api_request_and_validate):
        data = RandomUsers().generate_random_data()
        del data["password"]
        response = api_request_and_validate(Endpoints.REGISTER,
                                            method='post',
