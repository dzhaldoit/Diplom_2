...
class TestLogInUser:
    ...
    def test_login_existing_user(self, api_request_and_validate, create_user):
        response_created, data = create_user
        del data["name"]
        response = api_request_and_validate(Endpoints.LOGIN,
                                            method='post',
                                            data=data)
    ...
    def test_login_with_incorrect_data(self, api_request_and_validate):
    ...
    def test_login_with_incorrect_pass(self, api_request_and_validate, create_user):
        response_created, data = create_user
        del data["name"]
        data['password'] = ''
        response = api_request_and_validate(Endpoints.LOGIN,
    ...
    def test_login_with_incorrect_login(self, api_request_and_validate, create_user):
        response_created, data = create_user
        del data["name"]
        data['email'] = ''
        response = api_request_and_validate(Endpoints.LOGIN,
